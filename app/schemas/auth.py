...
class HelperProfileUpdateRequest(BaseModel):
    ...
    first_name: str = Field(..., min_length=1, max_length=50, description="Helper's first name")
    last_name: str = Field(..., min_length=1, max_length=50, description="Helper's last name")
    college: str = Field(..., min_length=1, max_length=100, description="Helper's college/university")
    bio: str = Field(..., min_length=10, max_length=500, description="Helper's bio")
    graduation_year: int = Field(..., ge=2020, le=2030, description="Expected graduation year")
...
class HelperVerificationWebhookData(BaseModel):
    ...
    email_confirmed_at: Optional[datetime] = Field(None, description="When email was confirmed")
    phone: Optional[str] = Field(None, description="User's phone number")
    phone_number: Optional[str] = Field(None, description="Alternative phone field")
    phone_confirmed_at: Optional[datetime] = Field(None, description="When phone was confirmed")
