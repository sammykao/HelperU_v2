...
class HelperVerificationWebhookData(BaseModel):
    ...
    email_confirmed_at: Optional[str] = Field(None, description="When email was confirmed")
    phone: Optional[str] = Field(None, description="User's phone number")
    phone_number: Optional[str] = Field(None, description="Alternative phone field")
    phone_confirmed_at: Optional[str] = Field(None, description="When phone was confirmed")
